  ...
  <body>
    <div class="container">
        ...
        <div id="cplog" class="row">
            <form id="interno" method="POST" action="/login/salvar">
                @csrf
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" name="usuario" class="form-control" id="exampleFormControlInput1" placeholder="Escreva o nome completo">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input name="email" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Escreva o número do seu CPF">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input name="senha" type="password" class="form-control" id="exampleFormControlInput1" placeholder="Escreva o número do seu CPF">
                        </div>
                    </div>
                </div>
                <div class="row">
